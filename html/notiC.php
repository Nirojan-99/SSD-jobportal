...
<body id="total">
	<div class="backL" id="backL">
		...
		$sql = "SELECT * 
        FROM employee a
        JOIN job b ON b.job_id = a.job_id
        JOIN applied_job c ON c.employee_id = a.employee_id
        WHERE b.company_id = (SELECT company_id FROM employer WHERE email = ?)";
