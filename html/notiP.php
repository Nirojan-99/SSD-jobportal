...
<body id="total">
	<div class="backL" id="backL">
		...
		$sql = "SELECT * 
        FROM interview a
        JOIN employer b ON b.company_id = a.employer_id
        JOIN job c ON c.job_id = a.job_id
        WHERE a.employee_id = (SELECT employee_id FROM employee WHERE mail = ?)";
